                        ...
                        <div class="contain_right"><div class="h_line1"></div>
							...
							?></div><div class="h_line1"></div>
                                <div class="gallery_box">
                                  ...
                                  <?php 
$sql2="select * from product_qty where ColorId='".$ColorId."' and SubcategoryId='".$SubcategoryId."'";

$rsqty=$objDB->select($sql2);
for($q=0;$q<count($rsqty);$q++){
$pid=$rsqty[$q]["ProductId"];

$sql5="select * from product where ProductId='".$pid."'";
$rspb=$objDB->select($sql5);

...
$MaterialId=loadVariable("MaterialId","");
...
$SQL1="select * from product_material where MaterialId =".$MaterialId."";
$rsUser2 = $objDB->select($SQL1);

$sql1="select * from product where MaterialId='".$MaterialId."' and SubCategoryId =".$SubcategoryId."";
$rsp=$objDB->select($sql1);
echo "We found"."&nbsp&nbsp".count($rsp)."&nbsp&nbsp"."Products for"."&nbsp&nbsp".$CategoryId."&nbsp&nbsp"."Apparels"."&nbsp&nbsp".$rsUser1[0]['SubCategory'].""."&nbsp&nbsp".$rsUser2[0]['MaterialName'];?>

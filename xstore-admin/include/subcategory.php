	...
	<div id="page-content">
			<div id="page-content-wrapper">
				...
				<div class="hastable">
                  ...
                  <script language="javascript" type="text/javascript">
                      ...
                      <?php if(!empty($rsUser)){ ?>
						...
						<tr>
							...
							<td class="center"><input name="multipledel[]" type="checkbox" id="multipledel[]" value="<?php echo $rsUser[$i]['SubCategoryId']?>"></td> 
                          <td><?php echo viewtext($rsUser[$i]['SubCategory']);?></td>
                            <td><?php
                           ...
                           <td><a href="<?php echo $AbsoluteURLAdmin;?>index.php?p=subcategory&a=edit&SubCategoryId=<?php echo $rsUser[$i]['SubCategoryId']?>" title="Edit" style="float:left" class="btn_no_text btn ui-state-default ui-corner-all tooltip"><span class="ui-icon ui-icon-wrench"></span></a>
								 ...
								 <div id="modal_confirmation<?php echo $i?>" title="Delete ?">
                                      <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Are you sure you want to Delete? This will Delete all the information related this Subcategory.</p>
                                 </div>
							 <script language="javascript" type="text/javascript">
                                    jQuery(document).ready(function() {
                                        jQuery("#modal_confirmation<?php echo $i?>").dialog({
                                            ...
                                            buttons: {
                                                'Delete': function() {
                                                    document.location.href="<?php echo $AbsoluteURLAdmin;?>manage.php?p=subcategory&a=delete&SubCategoryId=<?php echo $rsUser[$i]['SubCategoryId']?>";
                                                    jQuery(this).dialog('close');
                                                },
                                                Cancel: function() {
                                                    jQuery(this).dialog('close');
                  ...
                  <input type="button" class="ui-button float-right ui-state-default ui-corner-all" id="create-user" value="Add New Sub Category" onclick="document.location.href='index.php?p=subcategory&a=add' " >
               		<div class="clear"></div>
				</div>
				<div class="clear"></div>
			</div>
...
<div id="page-layout">
	<div id="page-content">
		<div id="page-content-wrapper">
            ...
            <?php }else{?>
            	<h2>View Sub Category/Edit Sub Category</h2>
            <?php }?>
			</div>
			<div class="content-box">
                    ...
                    <input type="hidden" name="p" value="subcategory">
                            <?php if($a == "edit"){ ?>
                      <input type="hidden" name="SubCategoryId" value="<?php echo $SubCategoryId?>">
                    	...
                    	<ul>
                        	<li>
                                ...
                                <input type="text" name="SubCategory" id="SubCategory"    value="<?php echo viewtext($SubCategory);?>" />
                            ...
                            <li>
                                ...
                                <?php for($i=0;$i<count($rscat);$i++){?>
                                <option value="<?php echo $rscat[$i]["CategoryId"];?>"><?php echo $rscat[$i]["Category"];?></option>
                                <?php }?>
                                </select>

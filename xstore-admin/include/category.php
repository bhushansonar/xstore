						...
						<tr>
                           ...
                           <td><a href="<?php echo $AbsoluteURLAdmin;?>index.php?p=category&a=edit&CategoryId=<?php echo $rsUser[$i]['CategoryId']?>" title="Edit" style="float:left" class="btn_no_text btn ui-state-default ui-corner-all tooltip"><span class="ui-icon ui-icon-wrench"></span></a>
								 ...
								 <div id="modal_confirmation<?php echo $i?>" title="Delete ?">
                                      <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Are you sure you want to Delete? This will Delete all the information related this Category.</p>
                                 </div>
								<script language="javascript" type="text/javascript">
                                    jQuery(document).ready(function() {
                                        jQuery("#modal_confirmation<?php echo $i?>").dialog({
                                            ...
                                            buttons: {
                                                'Delete': function() {
                                                    document.location.href="<?php echo $AbsoluteURLAdmin;?>manage.php?p=category&a=delete&CategoryId=<?php echo $rsUser[$i]['CategoryId']?>";
                                                    jQuery(this).dialog('close');
                                                },
                                                Cancel: function() {
                                                    jQuery(this).dialog('close');
...
$().ready(function() {
	...
	$("#FrmTestimonials").validate({
		...
		messages: {
			Testimonials: "Please enter your Category"
		}
	}
	});
});
	...
	<div id="page-content">
		<div id="page-content-wrapper">
            ...
            <?php if($a == 'add'){?>
				<h2>Add Category</h2>
            <?php }else{?>
            	<h2>View Category/Edit Category</h2>
            <?php }?>
			</div>

	...
	<div id="page-content">
			<div id="page-content-wrapper">
				<div class="inner-page-title">
					<h2>Material List<div style="float:right; font-size:16px;">
                  </div></h2>
                   <div class="clear"></div>
				</div>
				<div class="hastable">
                	<?php if(isset($_SESSION['success']) && $_SESSION['success'] != '' && $_SESSION['check'] == 'add'){ ?>
                      ...
                      <?php if(!empty($rsUser)){ ?>
						...
						<tr>
							<td class="center"><input name="multipledel[]" type="checkbox" id="multipledel[]" value="<?php echo $rsUser[$i]['CollarId']?>"></td> 
                            <td><?php echo viewtext($rsUser[$i]['CollarName']);?></td>
                            
                            
                           <td><a href="<?php echo $AbsoluteURLAdmin;?>index.php?p=collar&a=edit&CollarId=<?php echo $rsUser[$i]['CollarId']?>" title="Edit" style="float:left" class="btn_no_text btn ui-state-default ui-corner-all tooltip"><span class="ui-icon ui-icon-wrench"></span></a>
								...
								<script language="javascript" type="text/javascript">
                                    jQuery(document).ready(function() {
                                        jQuery("#modal_confirmation<?php echo $i?>").dialog({
                                            ...
                                            buttons: {
                                                'Delete': function() {
                                                    document.location.href="<?php echo $AbsoluteURLAdmin;?>manage.php?p=collar&a=delete&CollarId=<?php echo $rsUser[$i]['CollarId']?>";
                                                    jQuery(this).dialog('close');
                                                },
                                                Cancel: function() {
                                                    jQuery(this).dialog('close');
                     ...
                     <input type="button" class="ui-button float-right ui-state-default ui-corner-all" id="create-user" value="Add New Collar/Neck" onclick="document.location.href='index.php?p=collar&a=add'" >
               		<div class="clear"></div>
				</div>
				<div class="clear"></div>
			</div>
...
$().ready(function() {
	...
	$("#FrmTestimonials").validate({
		...
		messages: {
			CollarName: "Please enter your CollarName"
		}
	}
	});
});
...
<div id="page-layout">
	<div id="page-content">
		<div id="page-content-wrapper">
            ...
            <?php }else{?>
            	<h2>View Material/Edit Material</h2>
            <?php }?>
			</div>
			<div class="content-box">
                    ...
                    <input type="hidden" name="p" value="collar">
                            <?php if($a == "edit"){ ?>
	                        <input type="hidden" name="CollarId" value="<?php echo $CollarId?>">
                    	...
                    	<ul>
                        	<li>
                                ...
                                <input type="text" name="CollarName" id="CollarName"  class="field text small"  value="<?php echo viewtext($CollarName);?>" />

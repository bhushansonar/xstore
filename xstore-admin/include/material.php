				...
				<div class="hastable">
                	<?php if(isset($_SESSION['success']) && $_SESSION['success'] != '' && $_SESSION['check'] == 'add'){ ?>
                      ...
                      <?php if(!empty($rsUser)){ ?>
						...
						<tr>
							<td class="center"><input name="multipledel[]" type="checkbox" id="multipledel[]" value="<?php echo $rsUser[$i]['MaterialId']?>"></td> 
                            <td><?php echo viewtext($rsUser[$i]['MaterialName']);?></td>
                            
                            
                           <td><a href="<?php echo $AbsoluteURLAdmin;?>index.php?p=material&a=edit&MaterialId=<?php echo $rsUser[$i]['MaterialId']?>" title="Edit" style="float:left" class="btn_no_text btn ui-state-default ui-corner-all tooltip"><span class="ui-icon ui-icon-wrench"></span></a>
								...
								<script language="javascript" type="text/javascript">
                                    jQuery(document).ready(function() {
                                        jQuery("#modal_confirmation<?php echo $i?>").dialog({
                                            ...
                                            buttons: {
                                                'Delete': function() {
                                                    document.location.href="<?php echo $AbsoluteURLAdmin;?>manage.php?p=material&a=delete&MaterialId=<?php echo $rsUser[$i]['MaterialId']?>";
                                                    jQuery(this).dialog('close');
                                                },
                                                Cancel: function() {
                                                    jQuery(this).dialog('close');
                     ...
                     <input type="button" class="ui-button float-right ui-state-default ui-corner-all" id="create-user" value="Add New Material" onclick="document.location.href='index.php?p=material&a=add'" >
               		<div class="clear"></div>
				</div>
				<div class="clear"></div>
			</div>
...
$().ready(function() {
	...
	$("#FrmTestimonials").validate({
		...
		messages: {
			MaterialName: "Please enter your MaterialName"
		}
	}
	});
});
	...
	<div id="page-content">
		<div id="page-content-wrapper">
			...
			<div class="content-box">
                    ...
                    <input type="hidden" name="p" value="material">
                            <?php if($a == "edit"){ ?>
                    	...
                    	<ul>
                        	<li>
                                ...
                                <input type="text" name="MaterialName" id="MaterialName"  class="field text small"  value="<?php echo viewtext($MaterialName);?>" />
